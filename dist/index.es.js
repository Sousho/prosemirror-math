import { TextSelection, Plugin, EditorState, PluginKey, NodeSelection } from 'prosemirror-state';
import { EditorView, DecorationSet, Decoration } from 'prosemirror-view';
import { StepMap } from 'prosemirror-transform';
import { keymap } from 'prosemirror-keymap';
import { chainCommands, deleteSelection, newlineInCode } from 'prosemirror-commands';
import katex$1, { ParseError } from 'katex';
...
class MathView {
    ...
    renderMath() {
        ...
        try {
            katex$1.render(texString, this._mathRenderElt, this._katexOptions);
